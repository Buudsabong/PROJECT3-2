...
- contains representative recordings for two of the final four recording sites
...
Each audio filename consists of <Media ID>_<Recording date>.
<Filetype> --> PER54_20190116.wav was recorded 2019/01/16 in Peru.

Take a look at the "perfect_run.csv" to see an example of the submission format.

Please note: According to the 2020 rules, audio data from the validation set is 
not permitted as training data. However, 
you are allowed to optimize your scores based on the provided ground truth.
